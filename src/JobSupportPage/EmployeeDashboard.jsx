    ...
    <div className="employee-dashboard">
      ...
      <div className={`employee-sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <ul className="sidebar-menu">
          ...
          <li onClick={goToManagers}>My Assigns</li>
          <li onClick={goToTeamLeads}>Upload Resume</li>
          <li onClick={goToEmployees}>Upload Interview Schedule</li>
        </ul>
      ...
      <div className="employee-main-content">
        <Container>
          ...
          <Row className="card-row">
            <Col md={6}>
              <div className="employee-card navy"
