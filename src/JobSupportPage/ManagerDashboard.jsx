    ...
    <div className="manager-dashboard">
      ...
      <div className={`manager-sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <ul className="sidebar-menu">
          ...
          <li onClick={goToMyAssigns}>MyAssigns</li>
      ...
      <div className="manager-main-content">
        <Container>
          <Row className="card-row">
            <Col md={6}>
              <div className="manager-card green"
                 onClick={goToClients}
            ...
            <Col md={6}>
              <div
                className="manager-card cyan"
                onClick={goToMyAssigns}
                style={{ cursor: 'pointer' }}
              >
                <p>My Assigns</p>
                <h4>05</h4>
          ...
          <Row className="card-row">
            <Col md={6}>
              <div className="manager-card navy"
            ...
            <Col md={6}>
              <div className="manager-card blue"
