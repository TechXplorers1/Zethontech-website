            ...
            <tbody>
                {data.map((client) => (
                    <tr key={client.id} className="table-warning">
                        ...
                        <td>
                            <button className="accept" onClick={() => setShowSheet(true)}>
                                Google Sheet
                            </button>
                        </td>
                    </tr>
    ...
    return (
        <div className="admin-dashboard">
            ...
            <div className="dashboard-container">
                ...
                {showSheet && (
                    <div className="iframe-overlay"> <div className="iframe-wrapper">
                        <div className="iframe-header"> <h5>Google Sheet Preview</h5>
                            <button onClick={() => setShowSheet(false)}>Close</button> </div>
                        <iframe src="https://docs.google.com/spreadsheets/d/e/your-sheet-id/pubhtml" width="100%" height="600"
                            frameBorder="0" title="Google Sheet" ></iframe> </div> </div>)}
            </div>
        </div>
    );
};
